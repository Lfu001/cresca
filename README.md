...
Renames appear as `R100 old-path -> new-path`; a renamed file with edits still has its ordinary edit hunks when you inspect the prepared diff with Git or your editor.
